...
func NewChainApp(
	...
	app.ModuleManager = module.NewManager(
		...
		gov.NewAppModule(appCodec, app.GovKeeper, app.AccountKeeper, app.BankKeeper, IsLegacyProposalWhitelisted, app.GetSubspace(govtypes.ModuleName), IsModuleWhiteList),
